      ...
      <div className="hfh-container">
        ...
        <div className="founder-block">
          ...
          <Expandable collapsedHeight={320}>
            ...
            <p>But when he pushed to the next level, focus became the bottleneck. In his teens he was prescribed a stimulant that helped him lock in but left him unable to eat or train the way he needed to. The tool that was supposed to help was costing him the thing he cared about most.</p>
            <p className="founder-pull"><strong>So he made a decision that everyone around him thought was insane.</strong></p>
            <p>He walked away from the athletic path. He got off the stimulant. And he went looking for something that didn't come with a crash. Not a temporary fix. Something that would actually help his brain work the way he needed it to.</p>
          </Expandable>
          </div>
        </div>
        ...
        <div className="founder-block reverse">
          ...
          <Expandable collapsedHeight={340}>
            ...
            <p>Decades of government-funded research had explored how specific sound frequencies affect brain states. The findings, which had been classified and were later made public, explored how precise frequency patterns can influence brainwave states. Focus. Calm. Energy. Flow.</p>
            <p>J's realization: if frequency can help shift your state, and your state shapes everything you do, then this could be a real tool for anyone whose brain feels like it's working against them.</p>
